    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <Rentals>Rentals: </Rentals>    <RentalCheckbox  type="checkbox" name="rentals"  onChange={ handleChange }/><br/>
                <Rentals>Owing:   </Rentals>    <RentalCheckbox  type="checkbox" name="owing"    onChange={ handleChange }/><br/>
